...
public class KokoEatingBananasBSearch {
 ...
 public static int minEatingSpeed(int piles[] , int h)
 {
    ...
    int ans=-1;
    // apply binary search on the possible values of k --> (1, max of array )
   while (start<=end) {
 ...
 public static boolean isEatingSpeedValid(int piles[], int eatingSpeed, int hours)
 {
    int hoursSpent=0;
    for(int i=0;i<piles.length;i++)
    {
